...
.controller('ClientViewController', ['$scope', function($scope) {
	$scope.sections = [
		{ title: 'Public Charts', sref: "client", active:	false },
		{ title: 'Your Charts', sref: "client.charts", active: true},
		{ title: 'Help', sref: "client.support", active: false}
	];
}]) 
